...
```{r woemp_trend_food_exp, echo=FALSE, fig.height=3, fig.width=8}
woemp_crf_trend_food_exp <- trend_plot(test, 
                                       "food_exp_mo_pc_1", "Food Expenses (month/capita)", "Causal Random Forest")
woemp_tm_trend_food_exp <- trend_plot(main,
                                      "food_exp_mo_pc_1", "Food Expenses (month/capita)", "Two-model Approach")
cowplot::plot_grid(woemp_crf_trend_food_exp, woemp_tm_trend_food_exp, ncol = 2)
```
...
```{r woemp_trend_nondurable_exp, echo=FALSE, fig.height=3, fig.width=8}
woemp_crf_trend_nondurable_exp <- trend_plot(test, 
                                             "nondurable_exp_mo_pc_1", "Nondurable Goods Expenses (month/capita)",
                                             "Causal Random Forest")
woemp_tm_trend_nondurable_exp <- trend_plot(main,
                                            "nondurable_exp_mo_pc_1", "Nondurable Goods Expenses (month/capita)",
                                            "Two-model Approach")
cowplot::plot_grid(woemp_crf_trend_nondurable_exp, woemp_tm_trend_nondurable_exp, ncol = 2)
```
...
woemp_crf_trend_durables_exp <- trend_plot(test, 
                                           "durables_exp_mo_pc_1", "Durable Goods Expenses (month/capita)",
                                           "Causal Random Forest")
...
```{r woemp_pdp_food_Exp, fig.height=3, fig.width=8, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
woemp_tm_pdp_food_exp <- pdp_plot(woemp_tm_rf, main, 
                                  "food_exp_mo_pc_1", "Food Expenses (month/capita)", "Two-model Approach")
woemp_crf_pdp_food_exp <- pdp_plot(woemp_crf, X,
                                   "food_exp_mo_pc_1", "Food Expenses (month/capita)", "Causal Random Forest")
cowplot::plot_grid(woemp_crf_pdp_food_exp, woemp_tm_pdp_food_exp, ncol = 2)
```
