...
#### Step 09: Run Weighted OLS With Clustering
...
#### Step 10: Analyze Group-based properties
...
### Two-Models Approach With Random Forest
...
```{r}
gates_biz <- rf_gates("biz_index_all_1", "treatment", 
...
str(endline1_biz_nobiz)
```

```{r}
gates_biz_nobiz <- rf_gates("biz_index_all_1", "treatment", 
                            endline1_biz_nobiz, cluster = "areaid", num.iter = 1)
summary(gates_biz_nobiz[[1]])
```
...
```{r}
gates_biz_wo <- rf_gates("biz_index_all_1", "treatment", 
                         endline1_biz_wo, cluster = "areaid", num.iter = 1)
summary(gates_biz_wo[[1]])
```
