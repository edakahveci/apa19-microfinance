...
### The Effects of `total_exp_mo_pc_1` and `food_exp_mo_pc_1`
...
```{r}
area.food_exp.levels = cut(area.food_exp,
                           breaks = c(-Inf,
                                      quantile(area.food_exp, c(1/3, 2/3)),
                                      Inf))
summary(aov(area.score ~ area.food_exp.levels))
```
